...
<?php if (!Auth::isUser()): ?>
        </div> <!-- Close col-md-10 for Admin/Dev -->
    </div> <!-- Close row for Admin/Dev -->
</div> <!-- Close container-fluid for Admin/Dev -->
<?php endif; ?>

<footer class="footer mt-5 py-4 <?= Auth::isUser() ? 'bg-dark' : 'bg-dark' ?> text-white">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <h5 class="mb-3">
                    <i class="fas fa-link"></i> Menu
                </h5>
                <ul class="list-unstyled text-light small">
                    <?php if (Auth::isUser()): ?>
                        <li class="mb-2"><a href="index.php?c=shop&a=index" class="text-light text-decoration-none"><i class="fas fa-store"></i> Belanja</a></li>
                        <li class="mb-2"><a href="index.php?c=mytransactions&a=index" class="text-light text-decoration-none"><i class="fas fa-shopping-bag"></i> Pesanan Saya</a></li>
                        <li class="mb-2"><a href="index.php?c=profile&a=index" class="text-light text-decoration-none"><i class="fas fa-user-circle"></i> Profil</a></li>
                    <?php else: ?>
                        <li class="mb-2"><a href="index.php" class="text-light text-decoration-none"><i class="fas fa-home"></i> Dashboard</a></li>
                        <li class="mb-2"><a href="index.php?c=products&a=index" class="text-light text-decoration-none"><i class="fas fa-box"></i> Produk</a></li>
                        <li class="mb-2"><a href="index.php?c=transactions&a=index" class="text-light text-decoration-none"><i class="fas fa-shopping-cart"></i> Transaksi</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0 small">
                    Powered by <strong>Patra Ananda 1061</strong>
                </p>
            </div>
        </div>
    </div>
